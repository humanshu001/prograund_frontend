...
export default function Trackers() {
  ...
  const url = "https://popular-parrot-100.telebit.io/tracking-all/";
      ...
      <div className="message-box overflow-scroll" style={{ height: "92vh", overflowY: "scroll" }}>
       {
        trackers.map((tracker,index) => (
          ...
          <div className="d-flex ">
            <img src={tracker.user.image ? "https://popular-parrot-100.telebit.io/Files/"+tracker.user.image : profile} style={{ width: "70px", height: "70px", borderRadius: "50%", border: "2px solid var(--color-4)" }} alt="" />
