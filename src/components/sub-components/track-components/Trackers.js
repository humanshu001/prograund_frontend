    ...
    <>
      <div className="message-box overflow-scroll" style={{ height: "92vh", overflowY: "scroll"}}>
        {trackers.map((tracker,index) => (
          ...
          <div className="">
            <button className='btn mr-2' style={{ color: "var(--color-1)", backgroundColor: "var(--color-4)", letterSpacing: "1px", fontWeight: "900!important", border: "none", outline: "none", borderRadius: "5px", padding: "8px", }} to="/"><b>Remove</b></button>
          </div>
        </div>
        ))}
      </div>
