...
export default function ChatView() {
    const url = "http://127.0.0.1:8000/get-messages/";
    ...
    useEffect(() => {
        ...
        fetch('http://127.0.0.1:8000/profile/' + id.id, {
            method: 'GET'
        })
